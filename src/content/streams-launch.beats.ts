  ...
  beats: [
    {
      ...
      components: [
        ...
        { type: "title", text: "The Stacks event firehose." },
      ],
    },
    {
      id: "subscribe",
      ...
      background: { src: BG },
      components: [
        { type: "eyebrow", text: "real-time" },
        { type: "title", text: "Subscribe to every block." },
        {
          type: "code",
          code: {
            filename: "stream.ts",
...
for await (const event of streams.events.consume({
  ...
  ledger.append(event);
    ...
    },
    {
      ...
      background: { src: BG },
      components: [
        { type: "eyebrow", text: "signed" },
        { type: "title", text: "Every event, provable." },
        {
          type: "code",
          code: {
            filename: "verify.ts",
...
// checked against the server's public key.`,
    ...
    },
    {
      ...
      background: { src: BG },
      components: [
        { type: "eyebrow", text: "resumable" },
        { type: "title", text: "Resume from anywhere." },
        {
          type: "code",
          code: {
            filename: "resume.ts",
  ...
  process(event);
    ...
    },
    {
      ...
      background: { src: BG },
      components: [
        { type: "eyebrow", text: "reorg-safe" },
        { type: "title", text: "Forks, handled." },
        {
          type: "code",
          code: {
            filename: "reorg.ts",
  ...
  onReorg: (reorg, { cursor }) => {
    ...
    },
    {
      ...
      layout: "center",
      components: [
        { type: "title", text: "Stream it now." },
        { type: "code", code: { filename: "terminal", lang: "bash", source: `bun add @secondlayer/sdk` } },
        { type: "badge", text: "streams" },
        { type: "caption", text: "subscribe · verify · resume · reorg-safe" },
      ],
    },
  ],
};
